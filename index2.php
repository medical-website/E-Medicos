					...
					if(isset($_POST["submit"]))
					{
						...
						if($r)
						{
							...
							while($row=mysqli_fetch_array($r))
							{
								...
								echo "<th>Medicine Purpose</th>";
								echo "<th>Salts Contained</th>";
								echo "</tr>";
								echo "</thead>";
								echo "<tr>";
								echo "<tr>";
								echo "<td><?php echo $row ->aname;?></td>";
								echo "<td><?php echo $row ->apurpose;?></td>";
								echo "<td><?php echo $row ->asalts;?></td>";
								echo "</tr>";
								/*echo "<td><?php $row -> aname ?> </td>";
								echo "<td><?php $row -> apurpose ?> </td>";
								echo "<td><?php $row -> asalts ?> </td>";
								echo "</tr>";*/
								//echo "</br>";
								//echo "<p style='color:black; font-size: 25px; class=uppercase;'>MEDICINE NAME: ".$row['aname']."</p>";
								//echo $row['aname'];
								//echo "</br>";
								//echo "<p style='color:black; font-size: 25px;'>MEDICINE PURPOSE: To cure ".$row['apurpose']."</p>";
								//echo $row['apurpose'];
								//echo "</br>";
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						<h2>MEDICINES</h2>
						<p>Information about some commanly used medicines </p>
					</div>
				</div>
			</div>
			...
			<div class="popup-gallery row clearfix">
				...
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="ovadj8toqfzasqihwnai.png" alt="">
						<div class="box-content">
				...
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="medicines-for-nausea_3.jpg" alt="">
						<div class="box-content">
